...
@TeleOp(group = "drive")
public class ComponentTestNewPassThrough extends GorillabotsCentral {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        while(!isStopRequested()){
            ...
            telemetry.addData("out", passthrough.out);
            ...
            telemetry.addData("intake switch: ", intake.getSwitchState());
