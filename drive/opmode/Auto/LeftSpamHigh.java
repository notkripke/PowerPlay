...
public class LeftSpamHigh extends GorillabotsCentral {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence alignToPole1 = drive.trajectorySequenceBuilder(new Pose2d(-34.5,-62,0))//35x
                .setReversed(false)
                .lineToLinearHeading(new Pose2d(-38, -23, Math.toRadians(0)))
                .splineToSplineHeading(new Pose2d(-29.5, -4.5, Math.toRadians(60)), Math.toRadians(60))
        ...
        TrajectorySequence driveToStack = drive.trajectorySequenceBuilder(alignToPole1.end())
                ...
                .lineToLinearHeading(new Pose2d(-63, -12, Math.toRadians(0)))
                .build();
        ...
        TrajectorySequence toMiddlePole = drive.trajectorySequenceBuilder(driveToStack.end())
                ...
                .splineTo(new Vector2d(-29.5, -3), Math.toRadians(50))
                .build();
