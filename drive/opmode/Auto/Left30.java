...
public class Left30 extends GorillabotsCentral {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence alignToPole1 = drive.trajectorySequenceBuilder(new Pose2d(-34.5,-62,0))//35x
                ...
                .splineToSplineHeading(new Pose2d(-36, -16, Math.toRadians(40)), Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(-28.5, -4.15, Math.toRadians(40)), Math.toRadians(40))//x26.7
                .build();
        ...
        TrajectorySequence driveToStack = drive.trajectorySequenceBuilder(alignToPole1.end())
                ...
                .splineToSplineHeading(new Pose2d(-40, -11.5, Math.toRadians(0)), Math.toRadians(180))
        ...
        TrajectorySequence toMiddlePole = drive.trajectorySequenceBuilder(driveToStack.end())
                ...
                .splineToSplineHeading(new Pose2d(-28.7, -21.9, Math.toRadians(330)), Math.toRadians(330))//x27.7
                .build();
        ...
        TrajectorySequence stackFromCycle = drive.trajectorySequenceBuilder(toMiddlePole.end())
                ...
                .splineTo(new Vector2d(-62, -11.8), Math.toRadians(180))
                .build();
        ...
        TrajectorySequence park1 = drive.trajectorySequenceBuilder(alignToPole1.end())
                ...
                .lineToLinearHeading(new Pose2d(-58.5, -12, 0))
                .build();
